...
public class CommentSClient {
    ...
    private static <T> T request(String url, String contentType, HttpBodyWriter bodyWriter, Callback<T> callback) throws Exception {
        ...
        try {
            ...
            connection.setRequestProperty("cz", "cz");
